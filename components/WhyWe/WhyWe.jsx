  ...
  return (
    <div className="flex justify-center items-center flex-col md:flex-col-reverse lg:flex-row text-[#F2F2F2] py-10 md:py-20 lg:py-10">
      ...
      <div className="justify-center flex-1 flex flex-col ite p-0 md:p-0 lg:px-4">
        ...
        <lu>
          <li className="text-xl text-left mb-4 lg:text-[1.5rem]" ><strong className="text-[#26E1FF]">Implementación Odoo a medida de tu Negocio:</strong> Adaptamos y extendemos Odoo para cumplir con tus requisitos específicos, asegurando que cada función se alinee perfectamente con tus procesos corporativos.</li>
        </lu>
      </div>
    </div>
  )
