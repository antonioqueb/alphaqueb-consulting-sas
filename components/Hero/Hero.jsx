      ...
      <section className='pt-1 lg:pt-20 pb-12 bg-transparent mt-[4.5rem]'>
        <div className='mx-auto'>
          <div className='mx-auto text-center'>
            <h1 className='mb-8 text-[1.6rem] sm:text-5xl font-semibold leading-none text-white xl:text-[4.2rem] 2xl:text-[7rem] md:tracking-tight text-balance hover:shadow-xl transition-all duration-300 custom-text-size'>
