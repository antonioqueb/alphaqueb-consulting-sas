        ...
        <div className='mx-auto'>
          <div className='mx-auto text-center'>
            ...
            <h2 className='text-pretty px-0 mb-8 text-lg text-white md:text-[1.6rem] lg:px-4'>
              Solicita <strong>Gratis 1 Hora de Auditoría</strong> en integración de módulos Odoo personalizados para potenciar tu implementación asegurando que cada función se alinee perfectamente con los procesos de tus negocios.
            </h2>
